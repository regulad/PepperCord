...
def santa_hat_executor(
    ...
    pfp_image = pfp_image.resize((round(pfp_image.height / pfp_image.width * pfp_size_float), pfp_size))
    pfp_image.thumbnail((pfp_size, pfp_size))  # serves to center image if it is wider than it is tall
