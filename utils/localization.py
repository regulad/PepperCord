...
class Locale(Enum):
    ...
    en_US = json.load(open("resources/locales/en_US.json"))  # Hmm.... This isn't perfect.
    ...
    def get_message(self, message: Message) -> str:
        ...
        return self.value.get(message.value) or self.__class__.en_US.value.get(message.value)
